...
function promedioResultadosTest(resultadosTest) {
  ...
  for (var i = 0; i < resultadosTest.length; i++){
    let puntajeActual = resultadosTest[i]
    promedioPuntajes += puntajeActual
  }
    promedioPuntajes = promedioPuntajes / resultadosTest.length
